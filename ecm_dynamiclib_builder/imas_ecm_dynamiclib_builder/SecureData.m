...
+ (NSData *)encryptedData:(NSData *)data
    ...
    NSData *saltd = [password dataUsingEncoding:NSUTF8StringEncoding];  // size 8 bytes [self randomDataOfLength:kPBKDFSaltSize];
    NSLog(@"salt size: %lu", (unsigned long)[saltd length]);
    
    NSData *key = [self AESKeyForPassword:password salt:saltd];
